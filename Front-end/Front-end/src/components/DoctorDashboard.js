...
class DoctorDashboard extends Component {
    ...
    componentDidMount() {
        if (sessionStorage.getItem("role") == null || sessionStorage.getItem("role") !== "doctor") {
            window.location = "/"
        }
                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/doctor-current-app') }} className="btn btn-danger">VIEW</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/doctor-app-history') }} className="btn btn-danger">VIEW</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/create-appointment-slots') }} className="btn btn-danger">CREATE</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push({ pathname: '/show-appointment-slots-doctor', state: { doctorId: doctor.userId } }) }} className="btn btn-danger">VIEW</button>
                                </div>
                            </div>
                        </div>
                        <div className="row my-3">
