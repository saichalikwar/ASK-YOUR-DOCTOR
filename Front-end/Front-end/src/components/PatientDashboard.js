                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/specialization-list-by-city') }} className="btn btn-success">Book</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/current-app') }} className="btn btn-success">View</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/app-history') }} className="btn btn-success">View</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-6">
                        ...
                        <div className="col-sm-6">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <button onClick={() => { this.props.history.push('/get-donors-by-city-and-blood-group') }} className="btn btn-success">View</button>
                                </div>
                            </div>
                        </div>
                    </div>
